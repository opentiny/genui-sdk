...
/* eslint-disable prefer-const no-implicit-any*/
...
function isSpaceCombinator(node: selectorParser.Node) {
  return node.type === 'combinator' && /^\s+$/.test((node as any).value)
}
