...
import { BLOCK_CONTEXT_KEY, NOTIFY_CONTEXT_KEY, type NotifyHandler } from './renderer-settings';
...
export class RendererContextService {
  ...
  setBlock(block: Record<string, Type<any>>) {
    this.context[BLOCK_CONTEXT_KEY] = block ?? {};
  }
}
