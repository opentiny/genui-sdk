const DOC_DOMAIN =
  import.meta.env.VITE_GENUI_DOC_DOMAIN || "https://docs.opentiny.design";
const PLAYGROUND_DOMAIN =
  import.meta.env.VITE_GENUI_PLAYGROUND_DOMAIN ||
  "https://playground.opentiny.design";

const linkMap = {
  devDoc: `${DOC_DOMAIN}/genui-sdk`,
  playground: `${PLAYGROUND_DOMAIN}/genui-sdk`,
