<template>
  <div v-if="props.isFinished" class="assistant-footer" :class="{ 'is-last': isLastBubble }">
    <button class="footer-icon-btn" @click="handleRefresh" title="Refresh">
      <svg
        viewBox="0 0 24 24"
        width="16"
        height="16"
    ...
    <button class="footer-icon-btn" @click="handleCopy" title="Copy">
      <svg
        viewBox="0 0 24 24"
        width="16"
        height="16"
...
/* Hide by default for non-last bubbles, show on hover */
...
<style>
/* Global style: show toolbar when hovering over bubble content */
